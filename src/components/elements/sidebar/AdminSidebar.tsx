...
import { faBuilding, faChartLine, faMoneyCheck, faSignOutAlt, faUser, faHome } from '@fortawesome/free-solid-svg-icons';
...
const AdminSidebar: React.FC = () => {
  ...
  return (
    <div className={SidebarStyles.sidebar}>
      ...
      <Link href={config.frontAdminUserListUrl} className={SidebarStyles.link}>
        <div className={SidebarStyles.icon}>
