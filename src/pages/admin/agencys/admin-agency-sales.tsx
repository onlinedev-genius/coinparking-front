...
const AdminAgencySales: React.FC<{
  ...
  return (
    <>
      <CustomHead title='管理画面 代理店 売上履歴 | コインパーキング24' />
          ...
          <div className={AdminStyles['search-container']}>
            <div className={AdminStyles['search-item-container']}>
              <div className={AdminStyles['search-item-title-container']}>
                <div className={AdminStyles['search-item-title']}>
                  <span>絞り込み検索</span>
                </div>
              </div>
            </div>
          ...
          <div className={AdminStyles['tb-container']}>
            <div className={AdminStyles.tb}>
              <div className={AdminStyles['tb-header']}>
                <div className={AdminStyles['agency-sales-col1']}>No.</div>
                <div className={AdminStyles['agency-sales-col2']}>日時</div>
                <div className={AdminStyles['agency-sales-col3']}>駐車場名</div>
                <div className={AdminStyles['agency-sales-col4']}>売上</div>
                <div className={AdminStyles['agency-sales-col5']}>報酬</div>
              </div>
              {accessList.map((data, index) => (
                <div key={index}>
                  <div className={AdminStyles['tb-item']}>
                    <div className={AdminStyles['agency-sales-col1']}>{index + 1}</div>
                    <div className={AdminStyles['agency-sales-col2']}>{data.sale_date}</div>
                    <div className={AdminStyles['agency-sales-col3']}>{data.place_name}</div>
                    <div className={AdminStyles['agency-sales-col4']}>{data.price}</div>
                    <div className={AdminStyles['agency-sales-col5']}>{data.reward}</div>
                  </div>
                </div>
              ))}
            </div>
...
export default AdminAgencySales;
